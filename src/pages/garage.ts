...
export default class GaragePage extends Control {
  ...
  private createCar(): void {
    this.mainGarageContainer.controls.formCreate.onCreateCar = async (name: any, color: any) => {
  ...
  private updateCar(): void {
    this.mainGarageContainer.garageContainer.onSelectCar = (car) => {
      ...
      this.mainGarageContainer.controls.formUpdate.onUpdateCar = async (name: any, color: any) => {
